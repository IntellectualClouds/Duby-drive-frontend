...
const YachtEditForm = () => {
  ...
  const [yachtPhotosData, setYachtPhotosData] = useState([]);
  ...
  const apiCall = async (
    ...
    let apiUrl = `${host[0].hostUrl}/api/put/data/yachtDetails/update/byId`;
    let yachtPhotosDataStatus;

    if (selectedFiles !== null) {
      yachtPhotosDataStatus = "yes";
    } else {
      yachtPhotosDataStatus = "no";
    }
  ...
  useEffect(() => {
    ...
    setYachtPhotosData(propsLocation.state.data.yachtPhotosArray);

    setYachtName(propsLocation.state.data.yachtName);
    setYachtType(propsLocation.state.data.yachtType);
    setDealerCompanyId(propsLocation.state.data.dealerCompanyId);
    setCaptainIncluded(propsLocation.state.data.captainIncluded);
    setCrewMembers(propsLocation.state.data.crewMembers);
    setLocation(propsLocation.state.data.location);
    setCapacity(propsLocation.state.data.capacity);
    setYachtSize(propsLocation.state.data.yachtSize);
    setYachtRoom(propsLocation.state.data.yachtRoom);
    setYachtOverview(propsLocation.state.data.yachtOverview);

    setPerHourRentalCost(propsLocation.state.data.perHourRentalCost);
    setPerDayRentalCost(propsLocation.state.data.perDayRentalCost);
    setWeeklyRentalCost(propsLocation.state.data.weeklyRentalCost);
        ...
        <div className="col-lg-12 col-md-12">
          <div className="card wizard clearfix">
                ...
                <div style={{ display: "flex", flexWrap: "wrap" }}>
                  <div className="col-md-4">
                    ...
                    {yachtName.trim().length < 3 ? (
                      ...
                      >
                        Please enter updated yacht name
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                  ...
                  <div className="col-md-4">
                    ...
                    {capacity.trim().length < 1 ? (
                      ...
                      >
                        Please enter updated yacht capacity
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                  ...
                  <div className="col-md-4">
                    ...
                    {yachtSize.trim().length < 2 ? (
                      ...
                      >
                        Please enter updated yacht size
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                  ...
                  <div className="col-md-12" style={{ marginTop: 10, marginBottom: 20 }}>
                    <h4 style={{ color: "#8fbd56" }}>Edit Yacht Overview:</h4>
                    <JoditEditor
                      ref={editor}
                      value={yachtOverview}
                      onChange={(e) => {
            ...
            >
              ...
              >
                <h4 style={{ color: "#8fbd56" }}>
                  Edit Rental Period & Pricing:
                </h4>
                      ...
                      {imagesArr.length > 0 ? (
                        ...
                        >
                          ...
                          <span style={{ color: "red", fontWeight: "500" }}>
                            {" "}
                            (Upload Yacht Photos if you want to update it)
                          </span>
                        </p>
                      )}
                    </div>
                    ...
                    >
                      ...
                      {videoFile == null ? (
                        ...
                        >
                          ...
                          <span style={{ color: "red", fontWeight: "500" }}>
                            {" "}
                            (Upload Yacht Video if you want to update it)
                          </span>
                        </p>
                      ) : (
                        <p
