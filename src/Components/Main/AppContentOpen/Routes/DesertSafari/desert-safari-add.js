...
const DesertSafariForm = () => {
  ...
  // let placeholder = "write somethingi";
  ...
  const toogleSuccessModal = () => {
    ...
    Swal.fire({
      ...
      text: "Tour Package Details is added successfully",
  ...
  //! Calling Api for adding new desert safari data...
  const apiCall = async (
    desertSafariName,
    adultPrice,
    childPrice,
    ...
    let apiUrl = `${host[0].hostUrl}/api/post/data/desertSafari`;
  ...
  const fetchingAllDealers = async () => {
    try {
      ...
      // console.log('Failed while fetching all dealers data api: ', error);
    }
  };
        ...
        <div className="col-lg-12 col-md-12">
          <div className="card wizard clearfix">
            <div className="card-header border-bottom">
              <h3 className="card-title">Add New Tour Package</h3>
            </div>
            {/* Steps */}
            <div
...
export default DesertSafariForm;
