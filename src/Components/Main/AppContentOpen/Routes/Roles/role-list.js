...
const RoleTable = () => {
    ...
    const fetchingApi = async () => {
        let apiUrl = `${host[0].hostUrl}/api/get/data/roles`;
    ...
    const deleteRow = async (id) => {
        ...
        let apiUrl = `${host[0].hostUrl}/api/delete/data/role/row/byId`;
    ...
    const onChangeHandler = (e) => {
        ...
        if (inputValue.trim() == '') {
            ...
            const filterData = data.filter(({ id, roleName }) => (roleName.toLowerCase().includes(inputValue) || id.toString().includes(inputValue)));
        ...
        <>
            ...
            >
                <div className="btn btn-primary" style={{ marginBottom: 10 }}>
                    <Link to={"/roleForm"} style={{ color: "white" }}>
                        Add New Role
                    </Link>
                </div>
            </div>
                                ...
                                <h3 className="card-title">Roles List</h3>
                                {
                                    data.length > 0 ?
                                        <div className="main-header-center ms-3 d-none d-xl-block" style={{ position: 'relative' }}>
                                            <input autoCorrect="on" className="form-control" onChange={onChangeHandler} placeholder="Search Role..." type="search" style={{ paddingRight: 40 }} />
                                                        ...
                                                        currentData.map((item, index) => {
                                                            return (
                                                                <tr data-id="1" key={index}>
                                                                    ...
                                                                    <td data-field="name">{item.roleName}</td>
