...
const RoleForm = () => {
    ...
    const apiCall = async (role, status) => {
        let apiUrl = `${host[0].hostUrl}/api/post/data/roles`;
    ...
    const addNewRole = async (e) => {
        ...
        if (roleName.trim() == "") {
            Swal.fire({
                ...
                icon: "info",
                title: "Cannot process your entry!",
                text: "Please enter valid role name, Please enter correct details",
                showConfirmButton: true,
                timer: 3000,
                customClass: {
            ...
            setBtnDisable(true);
            apiCall(roleName.trim(), statusValue);
        }
    };
                        ...
                        <div className="card-body">
                            ...
                            >
                                ...
                                <div className="col-12">
                                    ...
                                    <button className="btn btn-primary" onClick={addNewRole} disabled={btnDisable}>
                                        {
                                            btnDisable ?
                                                <>
