...
const PackageEdiForm = () => {
  ...
  //! Calling Api for update package data...
  const apiCall = async (
    packageName,
    packageDuration,
    status,
    ...
    let apiUrl = `${host[0].hostUrl}/api/put/data/packages/update/byId`;
  ...
  useEffect(() => {
    ...
    setPackageName(location.state.data.packageName);
    setPackageDuration(location.state.data.packageDuration);
    setPackageSellPrice(location.state.data.packageSellPrice);
    setPackageOfferPrice(location.state.data.packageOfferPrice);
    setPackageDescription(location.state.data.packageDescription);
    setCurrencyType(location.state.data.currencyType);
    setCarLimit(location.state.data.carLimit);
  }, []);
  return (
    <>
            ...
            <div className="card-body">
              ...
              >
                <div className="col-md-12" style={{ display: "flex", flexWrap: 'wrap' }}>
                  <div className="col-md-3">
                    ...
                    {packageName.trim().length < 3 ? (
                      ...
                      >
                        Please enter updated Package Name
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                  ...
                  <div className="col-md-3">
                    ...
                    {packageDuration.trim().length < 1 ? (
                      ...
                      >
                        Please enter updated package duration
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                ...
                <div className="col-md-6">
                  ...
                  {file == null ? (
                    ...
                    >
                      ...
                      Upload package picture if you want to do update it
                    </label>
                  ) : (
                    <label
                      htmlFor="validationCustom01"
                ...
                <div style={{ display: "flex", flexWrap: "wrap" }}>
                  ...
                  <div className="col-md-3">
                    ...
                    {packageSellPrice.trim().length < 1 ? (
                      ...
                      >
                        Please enter updated Sell Price
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                  ...
                  <div className="col-md-3">
                    ...
                    {packageOfferPrice.trim().length < 1 ? (
                      ...
                      >
                        Please enter updated Offer Price
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                  ...
                  <div className="col-md-6">
                    ...
                    {packageDescription.trim().length < 5 ? (
                      ...
                      >
                        Please enter updated Package Description
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                ...
                <div className="col-12">
                  ...
                  <button className="btn btn-primary" onClick={editPackageData} disabled={btnDisable}>
                    {
                      btnDisable ?
                        <>
