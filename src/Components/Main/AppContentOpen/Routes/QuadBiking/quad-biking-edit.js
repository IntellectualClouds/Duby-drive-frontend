...
const QuadBikeEditForm = () => {
  ...
  const [quadBikePhotosData, setQuadBikePhotosData] = useState([]);
  ...
  //! Calling Api for updating bike details data...
  const apiCall = async (
    bikeName,
    dealerId,
    bikeType,
    ...
    let apiUrl = `${host[0].hostUrl}/api/put/data/quadBiking/update/byId`;
    let quadBikePhotosDataStatus;

    if (selectedFiles !== null) {
      quadBikePhotosDataStatus = "yes";
    } else {
      quadBikePhotosDataStatus = "no";
    }
  ...
  useEffect(() => {
    ...
    setQuadBikePhotosData(propsLocation.state.data.quadBikePhotosArray);

    setBikeName(propsLocation.state.data.bikeName);
    setDealerId(propsLocation.state.data.dealerId);
    setBikeType(propsLocation.state.data.bikeType);
    setSeats(propsLocation.state.data.seats);
    setDoors(propsLocation.state.data.doors);
    setFunDesertActivities(propsLocation.state.data.funDesertActivities);
    setSafetyGearAndTraining(propsLocation.state.data.safetyGearAndTraining);
    setFoodAndBeverages(propsLocation.state.data.foodAndBeverages);

    setMetaDescription(propsLocation.state.data.metaDescription);
    setMetaKeywords(propsLocation.state.data.metaKeywords);

    setPricePerHour(propsLocation.state.data.pricePerHour);
    setPriceTwoHour(propsLocation.state.data.priceTwoHour);
    setSnacksPrice(propsLocation.state.data.snacksPrice);
    setVatPercentage(propsLocation.state.data.vatPercentage);
    setSnacksDescription(propsLocation.state.data.snacksDescription);
                ...
                <div style={{ display: "flex", flexWrap: "wrap" }}>
                  <div className="col-md-3">
                    ...
                    {bikeName.trim().length < 3 ? (
                      ...
                      >
                        Please enter updated bike name
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                ...
                <div style={{ display: "flex", flexWrap: "wrap" }}>
                  <div className="col-md-3">
                    ...
                    {pricePerHour.trim().length < 1 ? (
                      ...
                      >
                        Please enter updated hourly price
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                  ...
                  <div className="col-md-3">
                    ...
                    {priceTwoHour.trim().length < 1 ? (
                      ...
                      >
                        Please enter updated 2 hour price
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                  ...
                  <div className="col-md-3">
                    ...
                    {snacksPrice.trim().length < 1 ? (
                      ...
                      >
                        Please enter updated snacks price
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                  ...
                  <div className="col-md-3">
                    ...
                    {vatPercentage.trim().length < 1 ? (
                      ...
                      >
                        Please enter updated vat percentage
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                  ...
                  <div className="col-md-12">
                    ...
                    {snacksDescription.trim().length < 5 ? (
                      ...
                      >
                        Please enter updated snacks description
                      </label>
                    ) : (
                      <label
                        htmlFor="validationCustom01"
                      ...
                      {imagesArr.length > 0 ? (
                        ...
                        >
                          ...
                          <span style={{ color: "red", fontWeight: "500" }}>
                            {" "}
                            (Upload Bike Photos if you want to update it)
                          </span>
                        </p>
                      )}
                    </div>
                    ...
                    >
                      ...
                      {videoFile == null ? (
                        ...
                        >
                          ...
                          <span style={{ color: "red", fontWeight: "500" }}>
                            {" "}
                            (Upload Bike Video if you want to update it)
                          </span>
                        </p>
                      ) : (
                        <p
...
export default QuadBikeEditForm;
